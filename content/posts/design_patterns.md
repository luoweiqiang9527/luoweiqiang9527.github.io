---
title: "设计模式"
date: 2023-08-03T09:14:19+08:00
draft: false
---

|[创建型模式](#创建型模式)|[Structural Design Patterns](#structural-design-patterns)|[Behavioral Design Patterns](#behavioral-design-patterns)|
|:-|:-|:-|
...
设计模式是反复出现的问题的解决方案;**如何解决某些问题的指导方针**。它们不是可以插入应用程序并等待奇迹发生的类、包或库。相反，这些是在特定情况下如何解决特定问题的指导方针。
